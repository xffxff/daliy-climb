...
- GPT-4 generally prefers longer answers among those that are generated by the same LLM with the same prompt
...
- There is a difference in verbosity preference between GPT-4 and Humans
